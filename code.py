# CircuitPython Bluetooth Controlled Smart Necktie
...
advertisement.complete_name = "SmartTie"
...
# If you use a CircuitPlayground Bluefruit & connect your Neopixel strand to pad A1, then
# uncomment the line below:
# led_pin = board.A1
# And if you use a CPB, comment out the line below.
led_pin = board.D12 # I've connected a Feather board to pin D12
# UPDATE NUMBER BELOW to match the number of NeoPixels you have connected
# 2" pitch neckties can usually fit 10 LED lights, 4" pitch usually fit 5.
num_leds = 10
...
def runSelectedAnimation():
    if animation_number == 1:
        ...
        # I set the "bounce" parameter below to True so that the comment bounces from end-to-end.
        cometAnimation = Comet(strip, speed=adjustedTime, color=pickedColor, tail_length=cometTailLength, bounce=True)
